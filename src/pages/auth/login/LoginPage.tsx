...
const title = (
  <span>
    <InfoCircleFilled style={{ color: "orange", marginRight: "5px" }} />
    Credenciales de prueba
  </span>
);
const content = (
  <div>
    <Text strong>Usuario:</Text> <Text copyable>test@vendorhub.com</Text>
    <br />
    <Text strong>Contraseña:</Text> <Text copyable>Test123!</Text>
  </div>
);
...
const LoginPage = () => {
  ...
  return (
    <div className={styles.container}>
      {contextHolder}
      <Popover open placement="rightTop" title={title} content={content}>
        <div className={styles.formContainer}>
          ...
          >
            <Form.Item<FieldType>
              ...
              name="email"
              initialValue="test@vendorhub.com"
